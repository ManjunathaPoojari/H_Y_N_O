    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Handle critical medical emergencies and assign doctors</p>
        </div>
      ...
      <Dialog open={showAssignDialog} onOpenChange={setShowAssignDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Assign an available doctor to handle this emergency case.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            {selectedRequest && (
            ...
            <div>
              ...
              <Select value={selectedDoctor} onValueChange={setSelectedDoctor}>
                ...
                <SelectContent>
                  {doctors.filter(doctor => doctor.available && doctor.status === 'approved').map((doctor) => (
